...
movie_table.memory_usage(deep=True).sum() + director_associative.memory_usage(deep=True).sum() + director_unique.memory_usage(deep=True).sum() + actor_associative.memory_usage(deep=True).sum() + actor_unique.memory_usage(deep=True).sum()
